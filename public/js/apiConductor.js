...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // datatables settings
    dtConductores = $('#dataTableConductores').DataTable({
...
function editarConductor(ente_id) {
    const url = '/conductores/' + ente_id + '/edit'
...
function verConductor(ente_id) {
    const url = '/conductor/detalles/' + ente_id + '';
