    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">
            ...
            <div class="card-body">
                ...
                <form id="formPropietarioRegister" method="POST" action="{{route('propietarios.store')}}">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group ">
                            <input type="submit" class="btn btn-outline-info " id="btnSavePropietario" value="Enviar">
