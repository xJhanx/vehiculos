...
<div class="ml-auto d-flex align-items-center secondary-menu text-center m-2">
    ...
    <a href="javascript:void(0)" class="tooltip-wrapper" data-toggle="modal" data-placement="top"
        data-target="#modalVehiculoRegister" title="Registrar">
        ...
        <div class="card card-statistics">
            <div class="card-body">
                <div class="export-table-wrapper table-responsive">
                    <table class="table table-bordered" style="color:black" id="dataTableVehiculos" width="100%" cellspacing="0">
                        <thead class="thead">
                            <tr>
                                <th>S. No</th>
                                <th>Propietario</th>
...
@include('admin.vehiculos.partials.formRegister')

@stop

@section('scripts')
<script src="{{ asset('/js/apiVehiculo.js') }}"></script>
<script src="{{ asset('/js/vehiculoListener.js') }}"></script>
