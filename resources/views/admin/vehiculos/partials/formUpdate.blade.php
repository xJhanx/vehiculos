                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="selectpicker form-control" data-live-search="true"="" name="estado"
                                        tag="estado">
                                        <option value="Activo" @if ($vehiculo->estado == 'Activo') {{ 'selected' }} @endif>Activo
                                        </option>
                                        <option value="Inactivo" @if ($vehiculo->estado == 'Inactivo') {{ 'selected' }} @endif>
                                            Inactivo</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="selectpicker form-control" data-live-search="true"=""
                                        ...
                                        <option value="Camioneta" @if ($vehiculo->tipo_vehiculo == 'Camioneta') {{ 'selected' }} @endif>
                                            Camioneta</option>

                                        <option value="Buseta" @if ($vehiculo->tipo_vehiculo == 'Buseta') {{ 'selected' }} @endif>
                                            Buseta</option>
                                        <option value="Bus" @if ($vehiculo->tipo_vehiculo == 'Bus') {{ 'selected' }} @endif>
                                            Bus</option>
                                        <option value="Microbus" @if ($vehiculo->tipo_vehiculo == 'Microbus') {{ 'selected' }} @endif>
                                            Microbus</option>
                                        <option value="Carrotanque" @if ($vehiculo->tipo_vehiculo == 'Carrotanque') {{ 'selected' }} @endif>
                                            Carrotanque</option>

                                        <option value="Maquinaria amarilla" @if ($vehiculo->tipo_vehiculo ==
        " Maquinaria amarilla") {{ 'selected' }} @endif>
                                            Maquinaria amarilla</option>

                                        <option value="Camion" @if ($vehiculo->tipo_vehiculo == 'Camion') {{ 'selected' }} @endif>
                                            Camión</option>
                                    </select>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="selectpicker form-control" data-live-search="true"=""
                                        ...
                                        <option value="Publico" @if ($vehiculo->tipo_servicio == 'Publico') {{ 'selected' }} @endif>
                                            Publico</option>
                                        <option value="Particular" @if ($vehiculo->tipo_servicio == 'Particular') {{ 'selected' }} @endif>
                                            Particular</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="selectpicker form-control  form-control"="" name="tipo_combustible"
                                        ...
                                        <option value="Gasolina" @if ($vehiculo->tipo_combustible == 'Gasolina') {{ 'selected' }} @endif>
                                            Gasolina</option>
                                        <option value="Diesel" @if ($vehiculo->tipo_combustible == 'Diesel') {{ 'selected' }} @endif>
                                            Diesel</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="selectpicker form-control  form-control"="" name="gps" tag="gps">
                                        <option value="Si" @if ($vehiculo->gps == 'Si') {{ 'selected' }} @endif>
                                            Si</option>
                                        <option value="No" @if ($vehiculo->gps == 'No') {{ 'selected' }} @endif>
                                            No</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="selectpicker form-control  form-control"="" name="botiquin"
                                        tag="botiquin">
                                        <option value="Si" @if ($vehiculo->botiquin == 'Si') {{ 'selected' }} @endif>
                                            Si</option>
                                        <option value="No" @if ($vehiculo->botiquin == 'No') {{ 'selected' }} @endif>
                                            No</option>
                                        <option value="Incompleto" @if ($vehiculo->botiquin == 'Incompleto') {{ 'selected' }} @endif>
                                            Incompleto</option>
                                    </select>
                                </div>
