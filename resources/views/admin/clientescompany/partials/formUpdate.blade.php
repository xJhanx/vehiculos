<div class="modal fade --" tabindex="-1" role="dialog" data-backdrop="static" data-ajax-modal id="modalClienteCompanyUpdate">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">

            <div class="card-header text-dark">Actualizar ClienteCompany
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <div class="card-body">

                <form id="formClienteCompanyUpdate" method="" action="{{route('clientescompany.update')}}">
                    @csrf
                    @method('PATCH')
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-outline-info " id="btnUpdateClienteCompany" value="Enviar">
