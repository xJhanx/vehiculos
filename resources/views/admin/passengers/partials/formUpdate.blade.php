    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">
            ...
            <div class="card-body">
                ...
                <form id="formPassengerUpdate" method="" action="{{route('passengers.update')}}">
                    @csrf
                    @method('PATCH')
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-outline-info " id="btnUpdatePassenger" value="Enviar">
