            ...
            <form id="formServiceUpdate" class="regiration_form" method="POST" action="{{route('servicios.update')}}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="point_start" readonly="true" name="data[punto_inicio]"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select form-control" id="estado" readonly="true" name="data[estado]">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="costo" readonly="true" name="data[costo]" placeholder="0">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="selectpicker form-control" data-live-search="true" readonly="true" name="conductor_id"
                            id="conductor_id" disabled="true">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea type="text" class="form-control" id="observaciones" readonly="true" name="data[observaciones]"
                            placeholder="Observaciones"></textarea>
                    </div>
                    
                    <div class="form-group col-md-6">
                        <label for="observaciones">Observaciones conductor </label>
                        <textarea type="text" class="form-control" id="observaciones_conductor" name="data[observaciones_conductor]"
                            placeholder="Observaciones"></textarea>
                    </div>
