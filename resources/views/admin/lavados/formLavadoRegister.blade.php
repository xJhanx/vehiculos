    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">
            ...
            <div class="card-body">
                ...
                <form id="formLavadoRegister" method="POST" action="{{route('lavados.store')}}">
                    @csrf
                    ...
                    <div class="form-group col-md-3">
                        <input type="submit" class="btn btn-outline-info " id="btnSaveLavado" value="Enviar">
