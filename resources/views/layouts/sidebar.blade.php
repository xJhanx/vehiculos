    ...
    <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                @endcan
                @can('allDesignados')
                    <a class="collapse-item" href="{{ route('viewDesignadosAll') }}">Designados</a>
                @endcan
    ...
    @can('isGerente')
        ...
        <li class="nav-item">
            <a class="nav-link collapsed text text-dark" href="#" data-toggle="collapse"
                data-target="#collapseBootstrapReportes" aria-expanded="true" aria-controls="collapseBootstrapReportes">
                <i class="fa fa-cogs"></i>
                <span>Gestión Resportes</span>
            </a>
            <div id="collapseBootstrapReportes" class="collapse" aria-labelledby="headingBootstrap"
